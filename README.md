...
# 松風,夕顔,若紫 / hiyokochan_n11, hiyokochan_f10, hiyokochan_f10tg 共通 ビルドガイド
...
→通常版用ビルドガイドはこちら <br/>
https://github.com/Eromis-keeb/hiyokochan_n11_matsukaze/blob/1b45388b3e427dea1a142e928ea64d2d5e6cb082/readme2.md <br/>
<br/>
...
Millmaxを使わずに組み立てることも出来ます。その場合はこの部分を飛ばして直接ロータリーエンコーダーを基板に取り付けてください。<br/>
...
ロータリーエンコーダーを直接取り付ける場合はこの時点でマスキングテープなどでエンコーダー本体をしっかり固定してから<br/>
はんだを多めに使って流しこんでしっかりと固定してください。<br/>
